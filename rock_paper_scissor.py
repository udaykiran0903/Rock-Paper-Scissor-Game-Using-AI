...
def checkWin(player,computer):
    if player == computer :
        ...
        if computer == "paper" :
            updateMessage("YOU LOOSE , PAPER COVERS ROCK...")
            updateComputerScore()
        else :
            updateMessage("YOU WIN , ROCK SMASHES SCISSOR...") 
            updateUserScore()  
    elif player == "paper":
        if computer == "rock":
            ...
            updateMessage("YOU LOOSE , SCISSOR CUTS PAPER...")
            updateComputerScore()
    elif player == "scissor":
        if computer == "rock":
            updateMessage("YOU LOOSE , ROCK SMASHES SCISSOR...")
            updateComputerScore()
        else :
            updateMessage("YOU WIN , SCISSOR CUTS PAPER...")
            updateUserScore()
